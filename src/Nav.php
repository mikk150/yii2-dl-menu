...
class Nav extends Widget
{
    ...
    public function init()
    {
        ...
        Html::addCssClass($this->parentMenuOptions, ['dl-menu']);
        Html::addCssClass($this->buttonOptions, ['dl-trigger']);
    }
    ...
    public function run()
    {
        DlMenuAsset::register($this->getView());
...
JAVASCRIPT;
    ...
    public function renderItem($item)
    {
        ...
        if (empty($items)) {
            ...
            Html::addCssClass($item['dropDownOptions'], 'dl-submenu');
            if (is_array($items)) {
    ...
    protected function renderDropdown($items, $parentItem)
    {
        return Html::tag(
            'ul',
            join(PHP_EOL, array_map([$this, 'renderItem'], $items)),
            ArrayHelper::getValue($parentItem, 'dropDownOptions', [])
        );
    }
